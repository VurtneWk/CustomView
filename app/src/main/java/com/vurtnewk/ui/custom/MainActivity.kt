...
import com.vurtnewk.ui.custom.tablayout.TabLayoutTestActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.mBtnTabLayout).setOnClickListener {
            TabLayoutTestActivity.start(this)
        }
